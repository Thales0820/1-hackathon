!(function (e, t) {
  ...
  const I = "SweetAlert2:",
    ...
    a = (e) => {
      console.warn(
        "".concat(I, " ").concat("object" == typeof e ? e.join(" ") : e)
      );
    },
    l = (e) => {
  ...
  const Me = (e, t) => {
    ...
    i &&
      ...
      "string" == typeof (n = t.backdrop)
        ...
        : n || k([document.documentElement, document.body], p["no-backdrop"]),
      (o = i),
      (n = t.position) in p
        ? k(o, p[n])
  ...
  const De = [
      ...
      return e && t.icon === e.icon
        ...
        ? t.icon && -1 === Object.keys(o).indexOf(t.icon)
          ? (l(
            ...
            x(n))
          : (B(n), Ze(n, t), ze(n, t), void k(n, t.showClass.icon))
        : x(n);
    },
    ze = (e, t) => {
    ...
    et = (e, t) => {
      ...
      t.toast)
        ? (k([document.documentElement, document.body], p["toast-shown"]),
          k(n, p.toast))
        : k(n, p.modal);
    ...
    Pt = (e, t, n) => {
      k(e, n.showClass.backdrop),
        ...
        n.heightAuto &&
          n.backdrop &&
          !n.toast &&
          k([document.documentElement, document.body], p["height-auto"]);
    },
    D = (e) => {
      let t = g();
      t || new vn(), (t = g());
  ...
  const Nt = (e) => {
      e.isAwaitingPromise()
        ? (Rt(L, e), L.awaitingPromise.set(e, !0))
        : (Rt(Ot, e), Rt(L, e));
    },
    Rt = (e, t) => {
  ...
  const ln = (t) => {
    for (let e = t.target; e && e !== document; e = e.parentNode)
      for (const o in cn) {
        ...
        if (n) return void cn[o].fire({ template: n });
      }
  };
  var un = Object.freeze({
    ...
    argsToParams: (n) => {
      const o = {};
      return (
        "object" != typeof n[0] || on(n[0])
          ? ["title", "html", "icon"].forEach((e, t) => {
              t = n[t];
              "string" == typeof t || on(t)
                ? (o[e] = t)
                : void 0 !== t &&
                  l(
                    "Unexpected type of "
    ...
    bindClickHandler: function () {
      var e =
        0 < arguments.length && void 0 !== arguments[0]
          ...
          : "data-swal-template";
      (cn[e] = this),
        sn || (document.body.addEventListener("click", ln), (sn = !0));
    },
  });
  let dn;
  class H {
      ...
      new Promise((e, t) => {
              ...
              (D(h()), xt(a, t));
        {
          ...
          "function" == typeof r.willOpen && r.willOpen(c),
            ...
            ae() && (At(s, r.scrollbarPadding, e), nt()),
            re() ||
